...
struct atom {
  ...
  float bfactor;	  // Record b-factor from PDB
...
struct contactlist contlist[10000];   // list of possible atom contacts
// ----------------- prototype definitions ------------------
struct atom *read_PDB(char *FILE_ptr, struct atom *PDB, long int *totatoms);
//int    index_protein(int totatoms,struct big_global big_g);
